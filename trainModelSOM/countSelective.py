...
def countMBFLFunctionSus(project, version):
    try:
        with open(faultlocalizationResultPath + "/" + project + "/" + version + "/susFunction/selective.json", "r") as f:
...
if __name__ == "__main__":
    ...
    for project in projectList.keys():
        ...
        for versionNum in range(1, projectList[project] + 1):
            ...
            topNResultBest,topNResultAverage,topNResultWorst = calTopN(project, version, susResult, "selective.json")
            MFR,MAR = calMFRandMAR(project, version, topNResultWorst, "selective.json")
